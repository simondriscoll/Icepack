...
!=======================================================================
      ...
      REAL(KIND=dbl_kind) :: fortran_layer_1_consts(18), &
       fortran_layer_2_consts(18), fortran_layer_3_consts(18), &
       fortran_layer_4_consts(18), fortran_layer_5_consts(18), fortran_layer_6_consts(4)
      ...
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_1(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_2(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_3(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_4(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_5(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_6(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_7(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_8(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_9(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_10(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_11(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_12(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_13(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_14(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_15(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_16(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_17(4)
      REAL (kind=dbl_kind) :: fortran_layer_3_weights_18(4)
...
fortran_layer_2_consts =    (/-0.2800149 , -0.24015978, -0.10848322, -1.6201998 /) 
      ...
      do i_loop = 1, 18
         layer_3(i_loop) = layer_3(i_loop) + fortran_layer_3_consts(i_loop)
      end do
      ...
      do i_loop = 1, 18
         layer_4(i_loop) = layer_4(i_loop) + fortran_layer_4_consts(i_loop)
      end do
      ...
      do i_loop = 1, 18
         layer_5(i_loop) = layer_5(i_loop) + fortran_layer_5_consts(i_loop)
      end do
      ...
      do i_loop = 1, 4
         layer_6(i_loop) = layer_6(i_loop) + fortran_layer_6_consts(i_loop)
      end do
