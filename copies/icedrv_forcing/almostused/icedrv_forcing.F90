...
! the time step and the data both start Jan 1.
      ...
      if (trim(atm_data_type) == 'CFS') then
         ...
         !Print *, "Icepack repeat forcing cycle"
         !Print *, "i is ", i
         ...
         !Print *,  "timestep  is ", timestep
         !Print *,  "ntime is ", ntime
         !Print *,  "mlast is ", mlast
         !Print *,  "mnext is ", mnext
         !Print *,  "c1intp is ", c1intp
         !Print *,  "c2intp is ", c2intp
         !Print *,  "size Tair is ", size(Tair)
         !Print *,  "String written in again maybe"
         !Print *,  nu_diag
         !Print *,  "Tair_data(mlast) is ", Tair_data(mlast)
         !Print *,  "==="
         !Print *,  "Tair_data(mnext) is ", Tair_data(mnext)
         !Print *,  "==="
         !Print *,  "Tair is ", Tair
         !Print *,  "Tair is ", Tair
         !Print *,  "Qa is ", Qa
...
!      Print *, "We are now inside icedrv_forcing.F90"
!      Print *, "+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+"
!      filename = trim(data_dir)//'/CFS/'//trim(atm_data_file)
!      Print *, "filename is: ", filename 
      !===
      ! output data into a file 
!!      open(1, file = '/Users/simondriscoll/data1.dat', status = 'old')  
!!      write(1,*) precip  
!      write(1,*) "String written in again maybe" 
!      write(1,*) nu_diag
!      close(1)
!     
!      open(1, file = '/Users/simondriscoll/data1.dat', status = 'old')  
!      write(1,*) precip  
!      write(1,*) "2String written in again maybe" 
!      write(1,*) nu_diag
!      close(1)
      !===
...
!      Print *, "Nu forcing is: ", nu_forcing
!      Print *, "dswsfc is ", dswsfc
!      Print *, "dlwsfc is ", dlwsfc
!      Print *, "windu10 is ", windu10 
!      Print *, "windv10 is ", windv10
!      Print *, "temp2m is ", temp2m
!      Print *, "spechum is ", spechum 
!      Print *, "precip is ", precip
...
!
!      Print *, "nt is ", nt
!      Print *, "flw_data is ", flw_data
!      Print *, "fsw_data is ", fsw_data
!      Print *, "uatm_data is ", uatm_data
!      Print *, "vatm_data is ", vatm_data
!      Print *, "Tair_data is ", Tair_data
!      Print *, "potT_data is ", potT_data
!      Print *, "Qa_data is ", Qa_data
!      Print *, "fsnow_data is ", fsnow_data


      close (nu_forcing)

      !Print *, "+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+"
      !Print *, "We are now leaving icedrv_forcing.F90"
      !Print *, "+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+_+"
